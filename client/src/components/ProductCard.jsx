...
export default function ProductCardComponent(){
    ...
    return (
        <div className="bg-gray-100">       
            <h1 className="mb-7 text-center text-2xl font-bold">Our Products</h1>
            <div className="flex flex-wrap justify-center ">
                {data.map(product => (
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg  max-w-xs mx-2 my-4">
                        ...
                        <div className="p-4 flex flex-col justify-between" style={{height:"14rem"}}>
                            ...
                            <div>
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link to={`/product/${product.id}`} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out">
                                        Buy Now
                                    </Link>
                                </div>
                            </div>
