                            ...
                            <div className="w-1/2 px-2">
                                <form className="max-w-xs mx-auto mb-2">
                                    ...
                                    <div className="relative flex items-center max-w-[8rem]">
                                        <button onClick={e => {if(amount > 0){setAmount(amount - 1)}}} type="button" id="decrement-button" data-input-counter-decrement="quantity-input" className="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-s-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none transition duration-300 ease-in-out">
                                        ...
                                        <button onClick={e => {setAmount(amount + 1)}} type="button" id="increment-button" data-input-counter-increment="quantity-input" className="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-e-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none transition duration-300 ease-in-out">
                                ...
                                <button onClick={e => {handleCart(id)}} className="w-full bg-gray-900 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 transition duration-300 ease-in-out">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                    <div className="md:flex-1 px-4">
